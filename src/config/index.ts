...
const useLocalCrypto = true;
const useLocalEndpoint = false;

const generateConfig = () => ({
  endpoint: useLocalEndpoint ? "http://localhost:3000" : "https://api.veilos.io",
  defaults: {
